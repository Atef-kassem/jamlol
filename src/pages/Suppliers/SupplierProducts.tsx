...
const SupplierProducts: React.FC = () => {
  ...
  const [sortBy, setSortBy] = useState<"name" | "price" | "location">("name");
        ...
        <CardContent className="p-4">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex gap-2">
              ...
              <Select value={sortBy} onValueChange={(value: "name" | "price" | "location") => setSortBy(value)}>
                <SelectTrigger className="w-48 text-right">
                      ...
                      <div className="space-y-4 text-right">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div>
                            ...
                            <p>{new Date(product.createdAt).toLocaleDateString('ar-SA')}</p>
                          </div>
                        </div>
                        <div>
