...
import { gregorianLocale, dateFormatOptions, timeFormatOptions } from "@/lib/dateConfig";
...
import { useGetMeQuery } from "../redux/Slices/auth";
...
export function Header() {
  ...
  const formatDate = (date) => {
    return date.toLocaleDateString(gregorianLocale, dateFormatOptions);
  };

  const formatTime = (date) => {
    return date.toLocaleTimeString(gregorianLocale, timeFormatOptions);
  };
