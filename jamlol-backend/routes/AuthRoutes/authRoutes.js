...
const { signup, login, forgotPassword, resetPassword, updatePassword } = require("../../controllers/Auth/authController");
const { getUser, updateMyData, deActivateUser, getMe } = require("../../controllers/User/userController");
